...
- шаблон задачи `.ai\tasks\templates\task_template.yaml`
...
Использовать шаблон `.ai\tasks\templates\order_template.yaml` (если доступен).
